...
class BpbRequestBody implements BearerRequestBody
{
    use InitiatorTrait;
    ...
    {
        return MpesaHelpers::getApiEndPointUrl('bpb');
    }
    ...
    public function postData(): array
    {
        return [
            ...
            "QueueTimeOutURL" => MpesaHelpers::getBpbCallbackUrl($this->timeoutUrl, 'timeout'),
            "ResultURL" => MpesaHelpers::getBpbCallbackUrl($this->callbackUrl, 'callback'),
        ];
    }
